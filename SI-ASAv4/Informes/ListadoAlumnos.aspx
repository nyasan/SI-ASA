<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ListadoAlumnos.aspx.cs" Inherits="Informes_ListadoAlumnos" %>
...
<label>Inscriptos desde: </label><asp:TextBox ID="txt_inscDesde" runat="server"></asp:TextBox><label>Hasta:</label><asp:TextBox
    ...
    <label>Ausentes desde: </label>
    <asp:TextBox ID="txt_ausDesde" runat="server"></asp:TextBox><label>Hasta</label><asp:TextBox
        ID="txt_ausHasta" runat="server"></asp:TextBox><br /><br />
